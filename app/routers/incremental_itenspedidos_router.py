...
@router.post("/limpar-itens-pedidos-incremental", response_model=ItensPedidosClean)
def limpar_itens(dados: ItensPedidosRaw) -> ItensPedidosClean:
    ...
    try:
        ...
        item_clean = limpar_um_item(dados)
